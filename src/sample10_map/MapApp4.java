...
public class MapApp4 {
	...
	public static void main(String[] args) {
		...
		// Map객체를 이용해서 다양한검색조건 정보를 저장할 수 있다.
		/*
		 ...
		 * 			map.get("seaRchKeyword");	// 오탈자가 있어도 오류가 발생하지 않음.
		 ...
		 * 			// Map객체에 처음 저장했던 타입 그대로 조회하기 위해 클래스 형번환이 필요하다.
		...
		map.put("searchKeyword", "토익시험");	// 검색 키워드
		map.put("minPrice", 15000);			// 최소 가격
		map.put("maxPrice", 30000);			// 최대 가격
