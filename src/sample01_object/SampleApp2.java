...
public class SampleApp2 {
	...
	public static void main(String[] args) {
		 ...
		 *  		- 참조변수가 참조하는 객체가 같은 객체를 참조하고 있을 때만 true
		 *  		- 비교연산자 == 는 객체에 대해서 동일성을 비교한다.
		 *  		- Object equals(Object obj)는 객체에 대해서 동일성을 비교한다.
		 *  	동등성 비교
		 *  		- 객체의 내용을 비교해서 같은 객체인지 비교하는 것
		 *  		- 객체의 멤버변수에 저장된 값이 서로 같으면 true
		 *  		- Object의 hashCode()와 equals(Object obj)를 재정의하면 동등성 비교를 할 수 있다.
		 *  		
		 */
		...
		// equals(Object obj)는 객체의 동일성을 비교해서 비교결과를 boolean값으로 반환
		// equals(Object obj)로 객체의 동등성 비교
