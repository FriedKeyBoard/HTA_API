...
public class BankingRepository {
	...
	/*
	 * 	Map<Integer,Account> 는 계좌정보를 저장하는 객체
	 * 		key는 계좌번호(Integer)
	 * 		value는 계좌정보(Account)
	 */
	...
	public BankingRepository() {
		...
		map.put(200, new Account(200, 1234, "강감찬", 150000));
		map.put(300, new Account(300, 1234, "강감찬", 3250000));
		map.put(400, new Account(400, 1234, "강감찬", 350000));
		map.put(500, new Account(500, 1234, "이순신", 2450000));
	}
	// 저장기능
	/*
	 * 계좌정복객체를 전달받아서 Map객체에 저장한다.
	 * 반환타입 : void
	 * 메소드명 : insertAccount
	 * 매개변수 : Account
	 */
	...
	// 조회기능
	/*
	 *	계좌번호를 전달받아서 계좌번호에 해당한느 계좌정보를 반환한다.
	 *	반환타입 : Account
	 *	메소드명 : getAccountByNo
	 *	매개변수 : int accNo
	 */
